...
```{r, TimeSeriesPlot}
## To make this plot we need to perform aggreate by steps and intervals, returning means.
...
```{r, newStepsStrategy}
## Using for loop to search all rows and assign new data to the missing data using the aggregate vector created previously.
...
## Create the histogram using the assigned value.
...
##Calculating the difference of median steps
